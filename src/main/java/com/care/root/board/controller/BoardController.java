...
public class BoardController{
	...
	public void writeSave(BoardDTO dto, @RequestParam(required = false) MultipartFile file_name, 
			HttpServletResponse res) throws IOException {
		//(required = false)파일이 없다면 null로 처리
		System.out.println(dto.getId());
		System.out.println(dto.getTitle());
		System.out.println(dto.getContent());
		System.out.println(file_name.getOriginalFilename());
		
		String msg=bs.writeSave(dto, file_name);
	...
	@PostMapping("modify")
	public void modify(BoardDTO dto, @RequestParam MultipartFile file, HttpServletResponse res) throws Exception {
